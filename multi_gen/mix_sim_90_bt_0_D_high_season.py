...
sim_0_file = '{}_summary.data'.format(runs.mix[3])
sim_2_file = '{}_summary.data'.format(runs.mix[4])
sim_4_file = '{}_summary.data'.format(runs.mix[5])
...
sim_0_rr = season.Seasonal.create(runs.mix[3], 83)
sim_2_rr = season.Seasonal.create(runs.mix[4], 82)
sim_4_rr = season.Seasonal.create(runs.mix[5], 57)
