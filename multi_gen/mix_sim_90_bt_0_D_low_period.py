...
sim_0 = period.Periodogram.create(runs.mix[0])
sim_2 = period.Periodogram.create(runs.mix[1])
sim_4 = period.Periodogram.create(runs.mix[2])

source_0 = mdl.ColumnDataSource(sim_0[runs.summaries[0]][runs.tables[2]][runs.columns[1]])
source_2 = mdl.ColumnDataSource(sim_2[runs.summaries[0]][runs.tables[2]][runs.columns[2]])
source_4 = mdl.ColumnDataSource(sim_4[runs.summaries[0]][runs.tables[2]][runs.columns[2]])
