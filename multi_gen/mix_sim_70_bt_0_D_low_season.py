...
sim_0_file = '{}_summary.data'.format(runs.mix[6])
# sim_2_file = '{}_summary.data'.format(runs.mix[4])
sim_4_file = '{}_summary.data'.format(runs.mix[7])
...
sim_0_rr = season.Seasonal.create(runs.mix[3], 80)
# sim_2_rr = season.Seasonal.create(runs.mix[4], 82)
sim_4_rr = season.Seasonal.create(runs.mix[5], 200)

sim_0_sr = season.Seasonal.create(runs.mix[3], 200)
# sim_2_sr = season.Seasonal.create(runs.mix[4], 200)
sim_4_sr = season.Seasonal.create(runs.mix[5], 200)

sim_0_ss = season.Seasonal.create(runs.mix[3], 200)
# sim_2_ss = season.Seasonal.create(runs.mix[4], 200)
sim_4_ss = season.Seasonal.create(runs.mix[5], 200)
