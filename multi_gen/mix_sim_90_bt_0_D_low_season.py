...
sim_0_file = '{}_summary.data'.format(runs.mix[0])
sim_2_file = '{}_summary.data'.format(runs.mix[1])
sim_4_file = '{}_summary.data'.format(runs.mix[2])
...
sim_0_rr = season.Seasonal.create(runs.mix[0], 83)
sim_2_rr = season.Seasonal.create(runs.mix[1], 82)
sim_4_rr = season.Seasonal.create(runs.mix[2], 57)

sim_0_sr = season.Seasonal.create(runs.mix[0], 200)
sim_2_sr = season.Seasonal.create(runs.mix[1], 200)
sim_4_sr = season.Seasonal.create(runs.mix[2], 200)

sim_0_ss = season.Seasonal.create(runs.mix[0], 200)
sim_2_ss = season.Seasonal.create(runs.mix[1], 200)
sim_4_ss = season.Seasonal.create(runs.mix[2], 200)
