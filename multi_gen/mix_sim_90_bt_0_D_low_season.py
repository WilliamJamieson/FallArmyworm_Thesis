...
save_file = 'mix_sim_90_bt_0_D_low_save.html'
...
sim_0_file = '{}_summary.data'.format(runs.low_90[0])
sim_1_file = '{}_summary.data'.format(runs.low_90[1])
sim_2_file = '{}_summary.data'.format(runs.low_90[2])
sim_3_file = '{}_summary.data'.format(runs.low_90[3])
sim_4_file = '{}_summary.data'.format(runs.low_90[4])
...
sim_0_rr = season.Seasonal.create(runs.low_90[0], 83)
sim_1_rr = season.Seasonal.create(runs.low_90[1], 80)
sim_2_rr = season.Seasonal.create(runs.low_90[2], 82)
sim_3_rr = season.Seasonal.create(runs.low_90[3], 91)
sim_4_rr = season.Seasonal.create(runs.low_90[4], 57)

sim_0_sr = season.Seasonal.create(runs.low_90[0], 200)
sim_1_sr = season.Seasonal.create(runs.low_90[1], 200)
sim_2_sr = season.Seasonal.create(runs.low_90[2], 200)
sim_3_sr = season.Seasonal.create(runs.low_90[3], 200)
sim_4_sr = season.Seasonal.create(runs.low_90[4], 200)

sim_0_ss = season.Seasonal.create(runs.low_90[0], 200)
sim_1_ss = season.Seasonal.create(runs.low_90[1], 200)
sim_2_ss = season.Seasonal.create(runs.low_90[2], 200)
sim_3_ss = season.Seasonal.create(runs.low_90[3], 200)
sim_4_ss = season.Seasonal.create(runs.low_90[4], 200)
